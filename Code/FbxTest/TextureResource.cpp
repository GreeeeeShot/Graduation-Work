...
{
	ppd3dTexture = new ID3D11ShaderResourceView*[5];
	...
	D3DX11CreateShaderResourceViewFromFile(pd3dDevice, _T("pirate.png"), NULL, NULL, &ppd3dTexture[4], NULL);
	...
	pPirateTexture->SetTexture(0, ppd3dTexture[4], CTextureResource::ppd3dSamplerState[SAMPLER_WRAP_MODE_0]);
	...
	//ppRegisteredTexture[7] = pPirateTexture;
}