...
CMesh* CMeshResource::pUI_KeyboardMesh = NULL;
...
void CMeshResource::CreateMeshResource(ID3D11Device *pd3dDevice)
{
	...
	pUI_KeyboardMesh = new CTexturedRectMesh(pd3dDevice, 920.0f, 420.0f, d3dxvUV);
...
void CMeshResource::DestroyMeshResource(void)
{
	...
	if (pUI_KeyboardMesh)
	{
		delete pUI_KeyboardMesh;
		pUI_KeyboardMesh = NULL;
	}
