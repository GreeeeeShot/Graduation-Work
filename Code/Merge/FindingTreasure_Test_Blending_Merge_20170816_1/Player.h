...
enum BELONG_TYPE {  BELONG_TYPE_BLUE, BELONG_TYPE_RED, BELONG_TYPE_INDIVIDUAL, BELONG_TYPE_UNKNOWN };
...
public:
	...
	void DestroyPlayersMgrInform(void);
...
public:
	CTreasureChest()
	{
		...
		m_fMaxRunVelM = 15.0f;			// 밀리는 속도에 대한 최대 크기
		m_fMass = 40.0f;               // 질량
