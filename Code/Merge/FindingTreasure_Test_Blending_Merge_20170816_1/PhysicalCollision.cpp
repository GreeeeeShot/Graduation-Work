...
bool CPhysicalCollision::ImpurseBasedCollisionResolution(CPlayer *pPlayerA, CPlayer *pPlayerB)
{
	if (pPlayerA == NULL || pPlayerB == NULL) return false;
	...
	if (fDistance > fRadiusA + fRadiusB) return false;
