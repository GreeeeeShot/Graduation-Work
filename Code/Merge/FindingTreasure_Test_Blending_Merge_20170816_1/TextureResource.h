...
public:
	...
	static ID3D11ShaderResourceView *pd3dTextureArrayVoxel;
	...
	static CTexture* pUI_Numbers;
	static CTexture* pUI_Keyboard;
	static CTexture* pUI_Result;
	...
	static void CreateTextureResource(ID3D11Device *pd3dDevice, ID3D11DeviceContext *pd3dDeviceContext);
