...
void CCamera::SetViewMatrix(D3DXMATRIX* pd3dxmtxViewMatrix)
{
	m_d3dxmtxView = *pd3dxmtxViewMatrix;
}

void CCamera::SetProjectionMatrix(D3DXMATRIX* pd3dxmtxProjMatrix)
{
	m_d3dxmtxProjection = *pd3dxmtxProjMatrix;
}

D3DXMATRIX CCamera::GetViewMatrix(void)
{
	return m_d3dxmtxView;
}

D3DXMATRIX CCamera::GetProjectionMatrix(void)
{
	return m_d3dxmtxProjection;
}

D3D11_VIEWPORT CCamera::GetViewport(void)
{
...
{
	return(IsInFrustum(pAABB->m_d3dxvMin, pAABB->m_d3dxvMax));
}
