...
{
public: 
	CDiffusedWorkingSpaceMesh(ID3D11Device *pd3dDevice, float fWidth = 1.0f, float fHeight = 1.0f, float fDepth = 1.0f, D3DXCOLOR d3dxvColor = D3DXCOLOR (1.0f, 0.0f, 1.0f, 1.0f));
