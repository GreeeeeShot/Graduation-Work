...
public:
	...
	void ReviseWorkingSpace(D3DXVECTOR3 d3dxvWorkingSpaceSize, D3DXVECTOR3 d3dxvCubeSize, D3DXVECTOR3 d3dxvOffsetFromLocal);
	void OptimizeWorkingSpace(void);
	
	CWorkingSpace* GetActivedWorkingSpace(void) { return m_pWorkingSpace[m_iActivedWorkingSpaceIdx]; }
	void ReleaseObjects();
