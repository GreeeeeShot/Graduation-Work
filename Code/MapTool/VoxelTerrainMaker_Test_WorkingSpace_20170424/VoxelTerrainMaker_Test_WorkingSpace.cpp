...
INT_PTR CALLBACK	EditWorkingSpaceReviseProc(HWND hDlg, UINT iMsg, WPARAM wParam, LPARAM lParam);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
	{
		...
		case IDM_EDIT_WORKINGSPACE_GENERATE:
			...
			break;
		case IDM_EDIT_WORKINGSPACE_REVISE:
			DialogBox(hInst, MAKEINTRESOURCE(IDD_EDIT_WORKINGSPACE_REVISE), hWnd, EditWorkingSpaceReviseProc);
			break;
		case IDM_FILE_SAVE:
		...
		case IDM_EDIT_MTRL_GRASS_0:
			if (gVTMakerFramework.m_pWorkingSpace) gVTMakerFramework.m_pWorkingSpace->ChangeMaterial(VOXEL_TYPE_GRASS_0);
			break;
		case IDM_EDIT_MTRL_WOOD_0:
			if (gVTMakerFramework.m_pWorkingSpace) gVTMakerFramework.m_pWorkingSpace->ChangeMaterial(VOXEL_TYPE_WOOD_0);
			break;
		case IDM_EDIT_MTRL_UPHILL_0:
			if (gVTMakerFramework.m_pWorkingSpace) gVTMakerFramework.m_pWorkingSpace->ChangeMaterial(VOXEL_TYPE_UPHILL_0);
			break;
		case IDM_EDIT_MTRL_UPHILL_1:
			if (gVTMakerFramework.m_pWorkingSpace) gVTMakerFramework.m_pWorkingSpace->ChangeMaterial(VOXEL_TYPE_UPHILL_1);
			break;
		case IDM_EDIT_MTRL_UPHILL_2:
			if (gVTMakerFramework.m_pWorkingSpace) gVTMakerFramework.m_pWorkingSpace->ChangeMaterial(VOXEL_TYPE_UPHILL_2);
			break;
		case IDM_EDIT_MTRL_UPHILL_3:
			if (gVTMakerFramework.m_pWorkingSpace) gVTMakerFramework.m_pWorkingSpace->ChangeMaterial(VOXEL_TYPE_UPHILL_3);
			break;
		case IDM_EDIT_MTRL_BUSH_0:
			if (gVTMakerFramework.m_pWorkingSpace) gVTMakerFramework.m_pWorkingSpace->ChangeMaterial(VOXEL_TYPE_BUSH_0);
			break;
		case IDM_EDIT_MTRL_SWAMP_0:
			if (gVTMakerFramework.m_pWorkingSpace) gVTMakerFramework.m_pWorkingSpace->ChangeMaterial(VOXEL_TYPE_SWAMP_0);
			break;
		case IDM_EDIT_MTRL_JUMP_0:
			if (gVTMakerFramework.m_pWorkingSpace) gVTMakerFramework.m_pWorkingSpace->ChangeMaterial(VOXEL_TYPE_JUMP_0);
			break;
		case IDM_EDIT_MTRL_SNOW_0:
			if (gVTMakerFramework.m_pWorkingSpace) gVTMakerFramework.m_pWorkingSpace->ChangeMaterial(VOXEL_TYPE_SNOW_0);
			break;
		case IDM_EDIT_MTRL_EMPTY_SNOW_0:
			if (gVTMakerFramework.m_pWorkingSpace) gVTMakerFramework.m_pWorkingSpace->ChangeMaterial(VOXEL_TYPE_EMPTY_SNOW_0);
			break;
		case IDM_EDIT_MTRL_ICE_0:
			if (gVTMakerFramework.m_pWorkingSpace) gVTMakerFramework.m_pWorkingSpace->ChangeMaterial(VOXEL_TYPE_ICE_0);
			break;
		case IDM_VIEW_ALL:
			if (gVTMakerFramework.m_pWorkingSpace) gVTMakerFramework.m_pWorkingSpace->ChangeViewMode(VIEW_MODE_ALL);
			break;
		case IDM_VIEW_ACCUMULATE:
			if (gVTMakerFramework.m_pWorkingSpace) gVTMakerFramework.m_pWorkingSpace->ChangeViewMode(VIEW_MODE_ACCUMULATE);
			break;
		case IDM_VIEW_RELEVANT:
			if (gVTMakerFramework.m_pWorkingSpace) gVTMakerFramework.m_pWorkingSpace->ChangeViewMode(VIEW_MODE_RELEVANT);
			break;
		case IDM_EXIT:
			DestroyWindow(hWnd);
			break;
...
INT_PTR CALLBACK	EditWorkingSpaceReviseProc(HWND hDlg, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
		...
		case ID_OK:
			...
			gVTMakerFramework.ReviseWorkingSpace(d3dxvWorkingSpaceSize, d3dxvCubeSize, d3dxvOffsetFromLocal);
			EndDialog(hDlg, 0);
			break;
		case ID_CANCEL:
			EndDialog(hDlg, 0);
