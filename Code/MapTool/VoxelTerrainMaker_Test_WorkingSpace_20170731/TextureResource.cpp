...
void CTextureResource::CreateTextureResource(ID3D11Device *pd3dDevice)
{
	...
	D3DX11CreateShaderResourceViewFromFile(pd3dDevice, _T("Texture/cpl/snow.png"), NULL, NULL, &ppd3dTexture[9], NULL);

	ppd3dTextureUI = new ID3D11ShaderResourceView*[2];
	D3DX11CreateShaderResourceViewFromFile(pd3dDevice, _T("Texture/cpl/UI_voxellist.png"), NULL, NULL, &ppd3dTextureUI[0], NULL);
	D3DX11CreateShaderResourceViewFromFile(pd3dDevice, _T("Texture/cpl/UI_voxelpocket.png"), NULL, NULL, &ppd3dTextureUI[1], NULL);
	...
	pZungleUphillTexture->SetTexture(0, ppd3dTexture[2], CTextureResource::ppd3dSamplerState[SAMPLER_WRAP_MODE_0]);
	...
	pSnowUphillTexture->SetTexture(0, ppd3dTexture[9], CTextureResource::ppd3dSamplerState[SAMPLER_WRAP_MODE_0]);
