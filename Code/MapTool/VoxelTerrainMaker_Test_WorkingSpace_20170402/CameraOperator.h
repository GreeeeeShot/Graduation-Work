...
#define CAMERA_VELOCITY						20.0f	// m/s
...
public:
	...
	void MoveForward(float fDistancePerSec, float fTimeElapsed);				// 'W'
	void MoveBack(float fDistancePerSec, float fTimeElapsed);					// 'S'
	void MoveRight(float fDistancePerSec, float fTimeElapsed);					// 'D'
	void MoveLeft(float fDistancePerSec, float fTimeElapsed);					// 'A'

	void MoveUp(float fDistancePerSec, float fTimeElapsed);						// 'V'
	void MoveDown(float fDistancePerSec, float fTimeElapsed);					// 'C'
