...
#define ZOOM_IN_LIMIT_DISTANCE				2.0f	// Meters
...
#define CAMERA_DISTANCE						12.0f	// Meters
#define CAMERA_ROTATION_DEGREE_PER_SEC		420.0f	// Degree
#define CAMERA_SOFT_MOVING_INTERVAL_NUM		230		// Num
...
public:
	...
	void RotateLocalY(float fAngle, float fTimeElapsed);							// m_d3dxvCameraDir을 로컬 Y축에 대하여 회전한다. ; 좌표계 전체도 움직인다.
	void RotateLocalX(float fAngle, float fTimeElapsed);							// m_d3dxvCameraDir을 로컬 Z축에 대하여 회전한다.
