...
void CTextureResource::CreateTextureResource(ID3D11Device *pd3dDevice)
{
	...
	ppTextureMaterial = new CTexture*[2];
	ppTextureMaterial[TEXTURE_GRASS_0] = new CTexture(1);
	ppTextureMaterial[TEXTURE_GRASS_0]->SetTexture(0, CTextureResource::ppd3dTexture[TEXTURE_GRASS_0], CTextureResource::ppd3dSamplerState[SAMPLER_WRAP_MODE_0]);

	ppTextureMaterial[TEXTURE_WOOD_0] = new CTexture(1);
	ppTextureMaterial[TEXTURE_WOOD_0]->SetTexture(0, CTextureResource::ppd3dTexture[TEXTURE_WOOD_0], CTextureResource::ppd3dSamplerState[SAMPLER_WRAP_MODE_0]);
}