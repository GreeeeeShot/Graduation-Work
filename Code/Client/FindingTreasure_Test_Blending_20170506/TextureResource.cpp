...
void CTextureResource::CreateTextureResource(ID3D11Device *pd3dDevice)
{
	...
	ppd3dTextureUI = new ID3D11ShaderResourceView*[3];
	...
	D3DX11CreateShaderResourceViewFromFile(pd3dDevice, _T("Texture/ui/UI_respawning.png"), NULL, NULL, &ppd3dTextureUI[2], NULL);
	...
	pUI_Respawning->SetTexture(0, ppd3dTextureUI[2], CTextureResource::ppd3dSamplerState[SAMPLER_WRAP_MODE_0]);
