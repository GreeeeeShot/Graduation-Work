...
public:
	...
	void RotateLocalY(float angle, float fTimeElapsed);							// m_d3dxvCameraDir을 로컬 Y축에 대하여 회전한다. ; 좌표계 전체도 움직인다.
	void RotateLocalX(float angle, float fTimeElapsed);							// m_d3dxvCameraDir을 로컬 Z축에 대하여 회전한다.
