...
{
	D3DXVECTOR3 m_LeftNormal = D3DXVECTOR3(-1.0f, 0.0f, 0.0f);
	D3DXVECTOR3 m_RightNormal = D3DXVECTOR3(1.0f, 0.0f, 0.0f);
	D3DXVECTOR3 m_FrontNormal = D3DXVECTOR3(0.0f, 0.0f, 1.0f);
	D3DXVECTOR3 m_RearNormal = D3DXVECTOR3(0.0f, 0.0f, -1.0f);
	D3DXVECTOR3 m_TopNormal = D3DXVECTOR3(0.0f, 1.0f, 0.0f);
	D3DXVECTOR3 m_BottomNormal = D3DXVECTOR3(0.0f, 1.0f, 0.0f);
}
