...
void CTextureResource::CreateTextureResource(ID3D11Device *pd3dDevice)
{
	...
	D3DX11CreateShaderResourceViewFromFile(pd3dDevice, _T("grass2.jpg"), NULL, NULL, &ppd3dTexture[0], NULL);
	...
	D3DX11CreateShaderResourceViewFromFile(pd3dDevice, _T("sea6.jpg"), NULL, NULL, ppd3dWaveTexture, NULL);
