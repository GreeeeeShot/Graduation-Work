...
void CScene::BuildObjects(ID3D11Device *pd3dDevice)
{
	...
	m_pVoxelTerrain->CreateVoxelTerrain(pTestMapBP->LoadBlueprint("test_map.txt"));
	//m_pVoxelTerrain->CreateVoxelTerrain(pTestMapBP->LoadBlueprint("performance_test_map.txt"), CShaderResource::pTexturedLightingShader);
	delete pTestMapBP;
