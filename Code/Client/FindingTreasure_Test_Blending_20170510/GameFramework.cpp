...
LRESULT CALLBACK CGameFramework::OnProcessingWindowMessage(HWND hWnd, UINT nMessageID, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_SIZE:
	{
		...
		m_pPlayersMgrInform->GetMyPlayer()->m_CameraOperator.GenerateProjectionMatrix(2.0f, 600.0f, float(m_nWndClientWidth) / float(m_nWndClientHeight), 60.0f);
...
void CGameFramework::AnimateObjects()
{
	...
	if (m_pPlayersMgrInform) m_pPlayersMgrInform->m_ppPlayers[m_pPlayersMgrInform->m_iMyPlayerID]->Animate(m_pd3dDeviceContext, current_time * 33);
}
