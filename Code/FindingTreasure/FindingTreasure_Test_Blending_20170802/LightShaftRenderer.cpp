...
void CLightShaftRenderer::CreateLightShaftSRVAndRTV(ID3D11Device *pd3dDevice, float fLightShaftMapW, float fLightShaftMapH)
{
	...
	pd3dDevice->CreateShaderResourceView(pLightMap, NULL, &m_pLightMapSRV);
	// 2. 라이트셰프트맵 SRV뷰 
	pd3dDevice->CreateShaderResourceView(pLightShaftMap, NULL, &m_pLightShaftMapSRV);
	...
	pd3dDevice->CreateRenderTargetView(pLightMap, NULL, &m_pLightMapRTV);
	// 2. 라이트셰프트맵 RTV뷰 
	pd3dDevice->CreateRenderTargetView(pLightShaftMap, NULL, &m_pLightShaftMapRTV);
