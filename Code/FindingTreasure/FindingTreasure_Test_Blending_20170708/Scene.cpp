...
void CScene::CreateShaderVariables(ID3D11Device *pd3dDevice)
{
	...
	m_pLights->m_pLights[2].m_d3dxcDiffuse = D3DXCOLOR(0.15f *1.8f, 0.1f *1.8f, 0.03f *1.8f, 1.0f);
	...
	m_pLights->m_pLights[4].m_d3dxcDiffuse = D3DXCOLOR(0.1f *1.8f, 0.0f, 0.035f *1.8f, 1.0f);
	m_pLights->m_pLights[4].m_d3dxcSpecular = D3DXCOLOR(0.1f, 0.2f, 0.2f, 8.0f);
	...
	m_pLights->m_pLights[6].m_d3dxvPosition = D3DXVECTOR3(70.f, 80.0f,0.);
