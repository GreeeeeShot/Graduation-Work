...
class CNormalMappingVertex
{
public:
	D3DXVECTOR3 m_d3dxvPosition;
	D3DXVECTOR3 m_d3dxvNormal;
	D3DXVECTOR3 m_d3dxvTexCoord;
	D3DXVECTOR3 m_d3dxvTBasis;

	CNormalMappingVertex(float x, float y, float z, float nx, float ny, float nz, float u, float v, float tx, float ty, float tz) { 
		m_d3dxvPosition = D3DXVECTOR3(x, y, z); 
		m_d3dxvNormal = D3DXVECTOR3(nx, ny, nz); 
		m_d3dxvTexCoord = D3DXVECTOR3(u, v, 0.0f); 
		m_d3dxvTBasis = D3DXVECTOR3(tx, ty, tz);
	}
	CNormalMappingVertex(D3DXVECTOR3 d3dxvPosition, D3DXVECTOR3 d3dxvNormal, D3DXVECTOR3 d3dxvTexCoord, D3DXVECTOR3 d3dxvTBasis) { 
		m_d3dxvPosition = d3dxvPosition; 
		m_d3dxvNormal = d3dxvNormal;
		m_d3dxvTexCoord = d3dxvTexCoord;
		m_d3dxvTBasis = d3dxvTBasis;
	}
	CNormalMappingVertex() { 
		m_d3dxvPosition = D3DXVECTOR3(0.0f, 0.0f, 0.0f); 
		m_d3dxvNormal = D3DXVECTOR3(0.0f, 0.0f, 0.0f); 
		m_d3dxvTexCoord = D3DXVECTOR3(0.0f, 0.0f, 0.0f);
		m_d3dxvTBasis = D3DXVECTOR3(1.0f, 0.0f, 0.0f);
	}
	~CNormalMappingVertex() { }
};
