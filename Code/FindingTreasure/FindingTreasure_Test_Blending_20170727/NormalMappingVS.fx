...
struct VS_TEXTURED_NORMAL_MAPPING_INPUT
{
	float3 position : POSITION;
	float3 normal : NORMAL;
...
VS_TEXTURED_NORMAL_MAPPING_OUTPUT VSNormalMapping(VS_TEXTURED_NORMAL_MAPPING_INPUT input)
{
	VS_TEXTURED_NORMAL_MAPPING_OUTPUT output = (VS_TEXTURED_NORMAL_MAPPING_OUTPUT)0;
