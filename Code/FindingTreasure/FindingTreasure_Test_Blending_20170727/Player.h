...
public:
	...
	void LiftPlayer(CPlayer *pPlayer, CVoxelTerrain *pVoxelTerrain);					// 들어올리는 작업
	void BeRelievedFromLiftingPlayer(void);					// 벗어나다.
	void BeDraggedAwayByLiftingPlayer(float fTimeElapsed);			// 끌려다니다.
