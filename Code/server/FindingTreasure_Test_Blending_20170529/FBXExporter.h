...
public:
	...
	D3DXVECTOR3* CopyMeshVertex(int* vertices);
	D3DXVECTOR3* CopyNormalVertex();
	D3DXVECTOR2* CopyUVVertex();
	void AnimationToVertex(D3DXVECTOR3** vec, int Frame_t);
	int GetAnimationnum() { return mAnimationLength; };
private:
