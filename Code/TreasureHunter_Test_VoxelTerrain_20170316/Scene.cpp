...
void CScene::BuildObjects(ID3D11Device *pd3dDevice)
{
	...
	CTexture *pGrassTexture = new CTexture(1);
	pGrassTexture->SetTexture(0, CTextureResource::ppd3dTexture[GRASS_TEXTURE_0], CTextureResource::ppd3dSamplerState[WRAP_MODE_SAMPLER_0]);
	...
	pCubeMesh->SetTexture(pGrassTexture);
	pCubeMesh->SetMaterial(pStandardMaterial);
